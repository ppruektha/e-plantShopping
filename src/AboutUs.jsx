...
function AboutUs() {
  return (
    <div className="about-us-container">
      ...
      <p className="about-us-description">Welcome to Green Oasis, your premier online destination for all things botanical!</p>
      <p className="about-us-content">
      At Green Oasis, we are passionate about bringing nature closer to you. Our mission is to provide a wide range of 
      ...
      <p className="about-us-content">
      Join us in our mission to create a greener, healthier world. Visit Green Oasis today and experience the 
